...
export const authOptions: NextAuthOptions = {
  providers: [
    SpotifyProvider({
      ...
      authorization: {
        params: {
          scope: "user-read-email user-read-private user-top-read user-read-recently-played playlist-read-private user-read-currently-playing user-read-playback-state",
        },
      },
    }),
  ],
